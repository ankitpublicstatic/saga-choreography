package com.ankit.saga.payment.service;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;
import org.springframework.transaction.annotation.Transactional;
import com.ankit.saga.commons.dto.OrderRequestDto;
import com.ankit.saga.commons.dto.PaymentRequestDto;
...
import com.ankit.saga.payment.repository.UserBalanceRepository;
import com.ankit.saga.payment.repository.UserTransactionRepository;
...
public class PaymentService {
  ...
  // .saveAll(Stream
  // .of(new UserBalance(101, 5000), new UserBalance(102, 3000), new UserBalance(103, 4200),
  // new UserBalance(104, 20000), new UserBalance(105, 999))
  // .collect(Collectors.toList()));
  // }

  /**
   * // get the user id // check the balance availability // if balance sufficient -> Payment
   * completed and deduct amount from DB // if payment not sufficient -> cancel order event and
